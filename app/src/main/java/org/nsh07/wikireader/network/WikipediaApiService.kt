...
private const val SEARCH_QUERY =
    "w/api.php?action=query&generator=search&prop=pageimages&piprop=thumbnail&pithumbsize=128&gsrnamespace=0&gsrlimit=20&gsrinfo=totalhits&gsrprop=snippet|titlesnippet|redirecttitle|extensiondata&format=json&formatversion=2"
